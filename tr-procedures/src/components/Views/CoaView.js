...
export function CoaView(base) {
    return class extends base {
            ...
            return html`
                    ...
                    <table class="pageformattable">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="page">
                                        ${this.coaResultsTable(data)}
                                        ${this.resultsTableExtraTables(data)}
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div id="pagefooter" class="document">
                    <div class="page-footer-space">
                        ${this.coaUsageDecision(data)}${this.coaSignatures(
                            data
                        )}
                    </div>
                </div>
                    ...
                    : html`
                          <div class="header-header">
                              <div class="title-copy">
                                  ${coaData.report_info[
                                      "provisional_copy_" + this.lang
                                  ]}
                              </div>
                              <div id="firstline-header">
                                  <div>
                                      ${coaData === undefined ||
                                      coaData.report_info.logo === undefined
                                          ? nothing
                                          : html`<img
                                                class="logo-header"
                                                src="${coaData.report_info
                                                    .logo}"
                                                alt="Logo"
                                            />`}
                                  </div>
                              ...
                              ${coaData.header === undefined
                                  ? nothing
                                  : html`
                                        <div style="padding: 0px 20px;">
                                            <div
                                                class="form-header"
                                                style=${coaData.report_info
                                                    .display_header_box_border
                                                    ? `border: 1px solid black;`
                                                    : ""}
                                            >
                                                ${coaData.header.column ===
                                                undefined
                                                    ? nothing
                                                    : html`
                                                          <div
                                                              class="form-fields col1"
                                                          >
                                                              ${coaData.header.column.map(
                                                                  (fld) => html`
                                                                      <label
                                                                          for="field1"
                                                                          >${fld[
                                                      ...
                                                      `}
                                                ${coaData.header.column2 ===
                                                undefined
                                                    ? nothing
                                                    : html`
                                                          <div
                                                              class="form-fields col2"
                                                          >
                                                              ${coaData.header.column2.map(
                                                                  (fld) => html`
                                                                      <label
                                                                          for="field1"
                                                                          >${fld[
        ...
        coaResultsTable(data) {
            ...
            console.log("coaData", coaData);
            return html`
                ${coaData == undefined || coaData.resultsTable === undefined
                    ? nothing
                    : html`
                          <style>
                              table,
                          ...
                          <div class="table-container-results">
                              ...
                              >
                                  ...
                                  >
                                      <tr>
                                          ${coaData.resultsTable.header ===
                                          undefined
                                              ? nothing
                                              : html`
                                                    ${coaData.resultsTable.header.map(
                                                        (fld) => html`
                                                            <th
                                                                style="font-weight: bold; font-size:18px; padding-top:6px; padding-bottom:6px;"
                                                            >
                                                                ${fld[
                                                                    "label_" +
                                                                        this
                                  ...
                                  <tbody>
                                      ${coaData.resultsTable.values ===
                                      undefined
                                          ? nothing
                                          : html`
                                                ${coaData.resultsTable.values.map(
                                                    (spec, i) => html`
                                                        <tr>
                                                            ${spec.map(
                                                                (fld) => html`
                                                                    <td
                                                                        style=${`padding:5px; ${
                                                                            ...
                                                                            -1
                                                                                ? coaData
                                                                                      .report_info
                                                                                      .display_result_box_column_bars
        ...
        coaUsageDecision(data) {
            let coaData = data; //FakeCOA
            return html`
                ${coaData == undefined || coaData.usageDecision === undefined
                    ? nothing
                    : html`
                          <style>
                          ...
                          <div class="usage-decision-container">
                              <label for="field1"
                                  >${coaData.usageDecision[
                                      "label_" + this.lang
                                  ]}</label
                              >
                              ${coaData.usageDecision.decided !== undefined &&
                              coaData.usageDecision.decided === true
                                  ? html`
                                        <span
                                            >${coaData.usageDecision[
                                                "value_" + this.lang
                                  ...
                                  : html`
                                        <span style="color:red;"
                                            >${coaData.usageDecision[
                                                "label_when_no_decision" +
                                                    this.lang
                                            ] === undefined
                                                ? ""
                                                : coaData.usageDecision[
                                                      "label_when_no_decision_" +
                                                          this.lang
                                                  ]}</span
                                        >
                                    `}
        ...
        coaSignatures(data) {
            let coaData = data; //FakeCOA
            return html`
                ${coaData == undefined || coaData.signatures === undefined
                    ? nothing
                    : html`
                          <style>
                              .signature-container {
                          ...
                          ${coaData.signatures === undefined
                              ? nothing
                              : html`
                                    <div class="signature-container">
                                        ${coaData.signatures.map(
                                            (curSign) => html`
                                                <div class="signature-box">
                                                    ...
                                                    ${curSign.manualsign !==
                                                        undefined &&
                                                    curSign.manualsign === true
                                                        ? html`
                                                              <div
                                                                  style="height: 100px; border: 1px dashed black; margin-top: 20px;"
                                                              ></div>
                                                          `
                                                        : nothing}
                                                    ${curSign.signed !==
                                                    ...
                                                    curSign.manualsign ===
                                                        false &&
                                                    curSign.sign_electronically_en !==
                                                        undefined &&
                                                    curSign.signed === true
                                                        ? html`
                                                              <div
        ...
        documentFooter(data) {
            ...
            let sessionUser =
                session.header_info.first_name +
                " " +
                session.header_info.last_name +
                " (" +
                session.userRole +
                ")";
            ...
            if (
                coaData == undefined &&
                coaData.report_info !== undefined &&
                coaData.report_info.report_information !== undefined
            ) {
                footerText += `${
                    coaData.report_info["report_information_" + this.lang]
                }`;
            }
            return footerText;
        }
        ...
        printCoa(data) {
            ...
            printWindow.document.title =
                coaData.report_info["provisional_copy_" + this.lang];
        ...
        setPrintContentCoa(data) {
            let headerData = "";
            let headerDataDiv =
                this.shadowRoot.querySelectorAll("div#document");
            ...
            let pagerFooter = "";
            let pagerFooterDiv =
                this.shadowRoot.querySelectorAll("div#pagefooter");
                ...
                * {
                ...
                @media print and (orientation: portrait) {
                  tr:nth-child(14n + 14) {
                    position: relative;
                    border-bottom: ${
                        data.report_info.display_result_box_border
                            ? `1px solid black;`
                            : `none;`
                    }
                    page-break-after: always;
                ...
                @media print and (orientation: landscape) {
                  ...
                  tr:nth-child(6n + 6) td:last-child::after {
                    display: block;
                    position: absolute;
                    top: 90px;
                    right: 0px;
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        tolueno, acetona y metanol, casi
                                        insoluble en agua.
                                    </td>
                                    <td>PCC-MMP-125</td>
                                    <td>Cumple</td>
