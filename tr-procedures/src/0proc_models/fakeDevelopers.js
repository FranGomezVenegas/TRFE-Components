export const FakeDevelopers = {
	TrackingChanges: {
		...
		last_change_note_20230805:
			"Created this fake procedure for developers then we don't need to mix our devs with official procedures",
	},
	ModuleSettings: {
		actionsEndpoints: [
			...
			columns: [
				{
					...
					tooltip: {
						...
						text_en:
							"the box {fld:name} is {fld?allow_move_objects ? open : close} {fld?name:Box 1? 'result1' :Caja A' ? 'result2' : 'default'}",
						text_es:
							'La caja {fld:name} está {fld?allow_move_objects ? abierta : cerrada}',
				...
				row_buttons: [
					{
						...
						endPoint:
							'/appProcMgr/RequirementsProcedureDefinitionAPIActions',
	...
	'drag-drop': {
		...
		viewQuery: {
			...
			endPointParams: [
				...
				{
					argumentName: 'incub1_whereFieldsValue',
					value: 'Incubation|false',
				},
				{
					argumentName: 'incub1_sortFieldsName',
					value: 'sample_id desc',
				},
				{
					argumentName: 'incub2_whereFieldsName',
					value: 'current_stage|incubation_passed',
				},
				{
					argumentName: 'incub2_whereFieldsValue',
					value: 'Incubation|true',
				},
				{
					argumentName: 'incub2_sortFieldsName',
					value: 'sample_id desc',
				},
				{
					argumentName: 'includeAllWithAnyPendingIncubation',
					value: true,
				},
				{
					argumentName: 'samplesWithAnyPendingIncubation',
					value: true,
				},
			],
		},
		objects: [
			...
			},
			{
				...
				dataIntegrityCheck: {
					dropingEntryRequiredProperties: [
						'sample_id',
						'study',
						'temperature',
					],
					...
					fields: [
						{
							text1: {
								label_en: 'Section 1',
								label_es: 'Sección 1',
								selObjectPropertyName: 'ip_value1',
							},
						},
						{
							text2: {
								label_en: 'Section 2',
								label_es: 'Sección 2',
								selObjectPropertyName: 'ip_value2',
							},
						},
						{
							text3: {
								label_en: 'Section 3',
								label_es: 'Sección 3',
								selObjectPropertyName: 'ip_value3',
							},
						},
						{
							text4: {
								label_en: 'Section 4',
								label_es: 'Sección 4',
								selObjectPropertyName: 'ip_value4',
							},
						},
						{
							text5: {
